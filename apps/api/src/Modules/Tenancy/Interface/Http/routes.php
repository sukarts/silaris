...
Route::prefix('admin')->group(function (): void {
    ...
    Route::get('/services', [OrganizationController::class, 'services'])->can('users.read');
    Route::post('/services', [OrganizationController::class, 'storeService'])->can('branches.create');
