...
MODULES = [
    ...
    ("Opérations", "Surestaries", "05-surestaries.png",
     "La question de chaque matin : quelles boîtes sortir aujourd'hui pour ne pas payer ?",
     ["Franchise négociée par connaissement à l'import, par booking à l'export",
      "Décompte ouvert par le déchargement, fermé par la restitution du vide",
      "Jalons alimentés par le suivi transporteur, pas ressaisis",
      "Alerte à trois jours, puis à échéance — exploitant et client"]),
